        ...
        <div class="w-5/6 mx-auto px-2 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-20">
            <div class="max-w-5xl mx-auto">
                ...
                <section class="mb-10 space-y-4 text-base sm:text-lg">
                    <h2 class="text-2xl font-semibold text-gray-800">1. Customer Support</h2>
                ...
                <section class="mb-10 space-y-4 text-base sm:text-lg">
                    <h2 class="text-2xl font-semibold  text-gray-800">2. Headquarters</h2>
                    <div class="text-gray-400">
                        <p class="py-4">
                ...
                <section class="space-y-4 text-base sm:text-lg">
                    <h2 class="text-2xl font-semibold text-gray-800">3. Connect with Us</h2>
                    <div class="text-gray-400">
                        <p class="py-4">
