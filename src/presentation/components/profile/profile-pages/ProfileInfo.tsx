...
export default function ProfileInfo() {
    ...
    return (
        <div class="w-full min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div class="bg-white w-full max-w-md md:max-w-lg rounded-2xl shadow-lg p-6 space-y-6">
                <div class="flex items-center space-x-4">
                    {/* Avatar with initials */}
                    <div class="h-16 w-16 bg-blue-600 text-white flex items-center justify-center rounded-full text-2xl font-semibold uppercase">
