    ...
    return (
        <div class="max-w-7xl mx-auto p-4">
            ...
            <div class="w-full flex justify-end my-10">
                <button onClick={() => navigate("/cart/checkout")} class="flex items-center gap-2 bg-blue-600 transition hover:bg-blue-700 cursor-pointer text-white py-2 px-3 rounded">
                    <div>Checkout</div>
                    <svg
